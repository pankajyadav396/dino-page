    ...
    return (
        <>
            <div className="relative bg-[#0A4740]">
                ...
                <img src={cloudShadow} alt="Cloud-Shadow"
                    className="w-full left-[-10%] absolute rotate-180 max-w-[509px] bottom-[-15%] z-[1]" />
                <img
                    src={topLayer} alt="top-Layer"
                    className="w-full absolute -top-1 left-0 z-[0]" />
                <img src={dinoElipse}
                    alt="TokenDragon" data-aos="zoom-in"
                ...
                <div
                    ...
                    id="Tokenomic">
                    <h3
                        className="text-white font-normal ff_chewy sm:text-[64px] text-[42px] leading-[131%] text-center xl:mb-[150px] lg:mb-[60px] mb-[45px]"
                    ...
                    <div className="flex items-center justify-center">
                        <div className="relative xl:max-w-[589.84px] lg:max-w-[515px] sm:max-w-[390px] max-w-[330px]">
                            <img
                                ...
                                className="xl:flex hidden absolute w-full lg:top-[-35%] left-[39%] max-w-[134px] up-down-anime"
                                data-aos="zoom-in" />
