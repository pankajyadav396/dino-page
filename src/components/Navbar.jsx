...
const Navbar = () => {
    ...
    return (
        <div className='px-4'>
            <nav
                className="max-w-[1156px] mx-auto lg:py-[15.8px] py-3 lg:ps-6 lg:pe-2 px-4 bg-white rounded-[61.102px] border-b-4 border-b-[black] flex items-center justify-between sm:mb-20 mb-10 h-[67px]">
                <a href="">
                    <h2
                        className="ff_lucky font-normal cursor-pointer leading-[90%] drop-shadow-[0px_1.337px_0px_#000] text-[#FBA11D] sm:text-[40px] text-[28px]">
                ...
                <ul
                    ...
                    <li><a onClick={show} href="#about"
                        className="text-black ff_chewy text-[18px] font-normal leading-normal hover:after:w-[80%] after:mx-auto after:right-0 after:items-center after:w-0 after:absolute after:bg-[#000000] after:h-[3px] relative after:left-[0] after:bottom-[-2px] after:rounded-[15px] after:transition-all after:duration-300 after:ease-linear">About</a>
                    </li>
                    ...
                    <li className="lg:hidden flex"><a href=""
                        className="bg-[url(./assets/images/joinbtn.webp)] bg-full bg-no-repeat text-black ff_chewy text-[18px] font-normal leading-normal px-9 pt-[11px] pb-[20px]">Join
                        Now</a></li>
                ...
                <ul className="gap-2 items-center sm:flex hidden">
                    ...
                    <li
                        className="bg-[url(./assets/images/joinbtn.webp)] cursor-pointer bg-full bg-no-repeat text-black ff_chewy text-[18px] font-normal leading-normal px-9 pt-[10px] pb-[17px] lg:block hidden hover:text-white transition-all duration-500 ease-in-out">Join
                        Now</li>
                </ul>
