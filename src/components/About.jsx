                ...
                <div className='relative z-10'>
                    ...
                    <div className=' max-w-[1000px] mx-auto px-2 sm:px-3'>
                        <div className=' flex justify-center items-center flex-col'>
                            <h2 className=' relative z-0 sm:text-[50px] text-[40px] md:text-[64px] font-normal ff_chewy text-[#FFFFFF]'>About <span className=' ff_lucky sm:text-[50px] text-[40px] md:text-[69.67px]'><span className='text-[#FBA11D] ff_lucky'>D</span><span className='text-[#23AAAC]'>i</span><span className=' text-[#D45B07]'>n</span><span className=' text-[#8EC627]'>o</span><span className='text-[#FCCA2B]'>L</span><span className=' text-[#8F78D2]'>F</span><span className=' text-[#8EC627]'>G</span></span></h2>
