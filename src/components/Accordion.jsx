            ...
            <div className='relative z-1 xl:mt-[290px] mt-[80px] sm:mt-0'>
                <div className='max-w-[801px] mx-auto px-3'>
                    <div className='mb-[240px]'>
                        ...
                        <Accordion data-aos="zoom-in-out" className=" justify-between bg-[#09655A] pr-[12px] pl-[10px] sm:pr-[32px] sm:pl-7  border-[white] border mb-4 sm:mb-8 rounded-[40.6px]" open={open === 1} icon={<OpenSign id={1} open={open} />}                >
                        ...
                        <Accordion data-aos="zoom-in-out" className=" justify-between bg-[#09655A] pr-[12px] pl-[10px] sm:pr-[32px] sm:pl-7  border-[white] border mb-4 sm:mb-8 rounded-[40.6px]  overflow-hidden" open={open === 2} icon={<OpenSign id={2} open={open} />} >
                        ...
                        <Accordion data-aos="zoom-in-out" className=" justify-between bg-[#09655A] pr-[12px] pl-[10px] sm:pr-[32px] sm:pl-7 border-[white] border mb-4 sm:mb-8 rounded-[40.6px]" open={open === 3} icon={<OpenSign id={3} open={open} />}>
                        ...
                        <Accordion data-aos="zoom-in-out" className=" justify-between bg-[#09655A] pr-[12px] pl-[10px] sm:pr-[32px] sm:pl-7  border-[white] border mb-4 sm:mb-8 rounded-[40.6px]" open={open === 4} icon={<OpenSign id={4} open={open} />}>
                        ...
                        <Accordion data-aos="zoom-in-out" className=" justify-between bg-[#09655A] pr-[12px] pl-[10px] sm:pr-[32px] sm:pl-7  border-[white] border mb-4 sm:mb-8 rounded-[40.6px] " open={open === 5} icon={<OpenSign id={5} open={open} />}>
